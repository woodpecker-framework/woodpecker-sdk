 ...
 *
 * 当一个信息探测插件被加载时，woodpecker框架调用InfoDetecPlugin#InfoDetecPluginMain方法，并传递实例
 * <code>InfoDetecPluginCallbacks</code>，供插件设置插件信息和注册相关组件。
 */
public interface InfoDetecPluginCallbacks {
     ...
     * @param name 插件名称
     */
    void setInfoDetecPluginName(String name);
     ...
     * @param version 插件版本
     */
    void setInfoDetecPluginVersion(String version);
     ...
     * @param path 插件路径
     */
    public void setInfoDetecPluginPath(String path);
     ...
     * @param author 插件作者
     */
    public void setInfoDetecPluginAuthor(String author);
    /**
     * 设置插件描述，可描述插件的功能
     *
     * @param description 插件描述
     */
    public void setInfoDetecPluginDescription(String description);
     ...
     */
    public void registerInfoDetec(List<InfoDetec> infoDetecList);
}
